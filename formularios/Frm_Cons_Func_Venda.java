...
public class Frm_Cons_Func_Venda extends javax.swing.JFrame {
    ...
    private int op;
    public Frm_Cons_Func_Venda(JFrame funcVenda, int op) {
        initComponents();
        setLocationRelativeTo(null);
        this.parent = funcVenda;
        this.op = op;
    }
    ...
    private void initComponents() {
        ...
        setTitle("BeautySystem - Selecione o Funcionário Vendedor");
    ...
    private void bt_alterarFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_alterarFuncActionPerformed
        ...
        f1.setTb_Funcionario(Integer.toString(funcionarios.get(index).getCodigo()));
        f1.setVisible(true);
        dispose();
        }
         else if (op==3)
        {
        int index = tblresultado.getSelectedRow();
        Frm_Agenda_Funcionario f1 = (Frm_Agenda_Funcionario)parent;
        f1.setTb_CodigoFunc(Integer.toString(funcionarios.get(index).getCodigo()));
        f1.setVisible(true);
        dispose();
        }
        else if (op==4)
        {
        int index = tblresultado.getSelectedRow();
        Frm_Rel_Prod f1 = (Frm_Rel_Prod)parent;
        f1.set_lbNomeFunc(Integer.toString(funcionarios.get(index).getCodigo()));
        f1.setVisible(true);
        dispose();
        }
        else if (op==4)
        {
        int index = tblresultado.getSelectedRow();
        Frm_Login f1 = (Frm_Login)parent;
        f1.setTb_codifoFunc(Integer.toString(funcionarios.get(index).getCodigo()));
        f1.setVisible(true);
        dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Cons_Func_Venda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Cons_Func_Venda(null,0).setVisible(true);
            }
        });
    }
